...
let question = prompt("What language do you speak : ")
...
let verb = prompt("Enter a string (It must be a verb) : ")
let end1 = "ly"
let end2 = "ing"
if(verb.length >= 3) {
    if(verb.endsWith("ing")) {
        console.log(verb.concat(end1))
    } else {
        console.log(verb.concat(end2))
    }
} else {
    console.log(verb)
}
